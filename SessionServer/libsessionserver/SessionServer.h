 ...
 *
 */
class SessionTaskManager : private boost::noncopyable
{
...
class SessionService : public x_subnetservice
{
  ...
  private:
     ...
     *
     */
    SessionService() : x_subnetservice("SessionServer",SESSIONSERVER)
    {
      taskPool = NULL;
...
class CSubject
{
  public:
    ...
    */
    ...
    {
#ifdef _DEBUG      
      Xlogger->debug("~CSubject:%s",this->title);
#endif        
    }
...
class RecordClient : public x_tcp_client,public MessageQueue
{
  ...
  public:
    ...
    RecordClient(
        ...
        const std::string &ip,
        const WORD port)
      : x_tcp_client(name,ip,port,false) {};
